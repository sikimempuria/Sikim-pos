...
const nextSteps = [
  ...
  "Planificar lecturas concretas con RLS y permisos revisados antes de tocar tablas reales.",
  ...
  return (
    ...
    >
      <div className="grid gap-2">
        ...
        <AdminNotice>No se realizan escrituras y Supabase Auth todavia no esta implementado.</AdminNotice>
      </div>
      ...
      <div className="grid gap-2 md:grid-cols-4">
        ...
        <MetricTile tone="light" label="Server helper" value={serverClient ? "Ready" : "Disabled"} detail="no auth cookies" />
      </div>
      ...
      <div className="grid gap-3 xl:grid-cols-[360px_1fr]">
        ...
        <Panel tone="light" title="Alcance de esta base" description="Cliente minimo para futuras lecturas seguras.">
          <div className="grid gap-2 md:grid-cols-2">
            {[
              "Solo URL publica y publishable key.",
              "Sin claves privadas o privilegiadas.",
              "Sin integracion de cookies o sesiones Supabase Auth.",
              "Sin consultas a tablas de negocio.",
              "Sin escrituras ni migraciones.",
